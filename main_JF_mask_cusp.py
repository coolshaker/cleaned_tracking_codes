...
for videoIndex in range(16,17):
	...
	videoPath="/home/cusp/kx273/aig_videos/Jay_Fulton_mask/"+"000"+str(videoIndex)+"_ROI.avi" #define the path of video or images
	outputPath="/home/cusp/kx273/aig_videos/Jay_Fulton_mask/Output"+str(videoIndex)+"/"
